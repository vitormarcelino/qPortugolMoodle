...
$string['pluginnameediting'] = 'Editing an QPortugol question';
$string['pluginnamesummary'] = 'Allows students to answer questions with the Portuguese pseudolanguage programming. While the student writes his code to the question, it is possible to execute the same through the built-in interpreter.';
